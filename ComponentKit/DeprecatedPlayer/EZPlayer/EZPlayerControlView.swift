...
open class EZPlayerControlView: UIView{
    ...
    override open func awakeFromNib() {
      ...
      self.playPauseButton.contentEdgeInsets = UIEdgeInsets(top: 10, left: 17, bottom: 10, right: 17)
      self.fullEmbeddedScreenButton.contentEdgeInsets = UIEdgeInsets(top: 10, left: 17, bottom: 10, right: 17)
      self.airplayContainer.isHidden = true
    }
        ...
        if animated{
            ...
            UIView.animate(withDuration: ezAnimatedDuration, delay: 0,options: .curveEaseInOut, animations: {
                if self.player?.displayMode == .fullscreen{
                  ...
                  self.navBarContainer.isHidden = true
                }
                self.autohidedControlViews.forEach{
                    $0.alpha = 1
                }
