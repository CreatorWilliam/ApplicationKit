...
public protocol PlayerViewControllable {
  ...
  /// PlayerView播放的时候更新
  func playerView(_ playerView: PlayerView, updateProgressWithCurrentTime currentTime: Double, bufferingTime: Double, totalTime: Double)
}

//public extension PlayerViewControllable {
//
//  /// 当PlayerView创建的时候，将会调用该函数，用于保存playerView对象
//  func update(playerView: PlayerView) { }
//
