...
public extension Network {
  ...
  public func upload(with file: URL, _ action: @escaping UploadTaskCompleteAction) {
  ...
  ///   - action: 上传完成或出现异常后进行回调，处理上传完成后服务器返回信息及错误信息
  public func upload(with data: Data, _ action: @escaping UploadTaskCompleteAction) {
